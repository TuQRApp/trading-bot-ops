...
║   21 instrumentos  |  M5/M15/H1  |  IC Markets MT5                  ║
╠══════════════════════════════════════════════════════════════════════╣
║  Índices : STOXX50 ES35 UK100 DE40 IT40 USTEC US500                 ║
║            HK50 CHINA50 NETH25 NOR25 SE30                           ║
║  Energía : WTI_M6 XTIUSD XNGUSD                                     ║
║  Metales : XAUUSD                                                   ║
║  Agrícola: Cotton_N6 Wheat_N6 Sbean_N6                              ║
║  Cripto  : BTCUSD                                                   ║
╠══════════════════════════════════════════════════════════════════════╣
...
CONFIG = {
    "symbols"        : [
        ...
        "USTEC", "US500", "HK50", "CHINA50", "NETH25", "NOR25", "SE30",
        # Energía (3)
        "WTI_M6", "XTIUSD", "XNGUSD",
        # Metales (1)
        "XAUUSD",
        # Agrícolas (3)
        "Cotton_N6", "Wheat_N6", "Sbean_N6",
        # Cripto (1)
        "BTCUSD",
    ],
    "days_back"      : 60,
...
║   21 instrumentos · IC Markets MT5                                  ║
╠══════════════════════════════════════════════════════════════════════╣
║   Ctrl+C para detener                                               ║
